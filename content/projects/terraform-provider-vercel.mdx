...
date: "2021-03-16"
repository: Walshe/terraform-provider-vercel
url: https://registry.terraform.io/providers/Walshe/vercel/latest
published: true
---
...
terraform {
  required_providers {
    vercel = {
      source  = "registry.terraform.io/Walshe/vercel"
      version = ">=0.10.3"
    }
  }
}
...
resource "vercel_project" "my_project" {
  ...
  git_repository {
    type = "github"
    repo = "Walshe/terraform-provider-vercel"
  }
}
```
...
Now that Vercel have stepped in, I have decided to [deprecate](https://twitter.com/Walshe_/status/1517759708983177218) this one on April 23rd 2022. 
